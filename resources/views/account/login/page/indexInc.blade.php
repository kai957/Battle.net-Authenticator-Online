...
<div id="wrapper">
    ...
    <div id="content" class="login">
        <div id="left">
            ...
            <form id="form" method="post" action="/login">
                ...
                <p><label class="label" for="accountName"> 用户名 </label>
                    ...
                    @else
                        <input id="accountName" class='input' type="text" value="" name="username" maxlength="32"
                               tabindex="1"/>
                    @endif
                </p>
                ...
                @elseif(@$loginCheckUtils->getLoginErrorCode()==3)
                    ...
                    <div class="imgandreloader">
                        <div id="captcha-image" style="width: 200px;height: 70px;"><img id="sec-string" onclick="refreshCaptcha();
        document.getElementById('letters_code').focus();" src="/api/captchaCode?rand={{time()}}" alt="换一个" title="换一个"
                                                     class="border-5"/></div>
                    ...
                    <p>
                        ...
                        @if(@$loginCheckUtils->getLoginErrorCode()==1)
                            <input id="letters_code" class='input input-error'
                                   ...
                                   type="text"
                                   onblur="if (!jquerycodechecked) {
                                checkyanzhenma(this.value);
                            }" style="width:285px;" name="letters_code" maxlength="6" tabindex="2" autocomplete="off"/>
                        @else
                    ...
                    <p><span id="remember-me"><label for="persistLogin" style="position: relative;top: 4px;">
                        ...
                        <button id="creation-submit" class="ui-button button1" type="submit" data-text="正在处理……"
                                onClick='return submitcheck();'><span class="button-left"><span class="button-right">
                                登录
                            </span></span></button>
                    </p>
            </form>
            <ul id="help-links">
                <li class="icon-pass"><a href="/forgetPassword">
                        忘记密码？
                    </a></li>
        ...
        <div id="right">
            ...
            <h3>
                注册{{config('app.name')}}账号，简单且免费，即可享受随时随地的安全令动态验证码提取系统！
            </h3>

            <a class="ui-button button1" href="/register"><span class="button-left"><span class="button-right">
                        创建一个{{config('app.name')}}账号
                    </span> </span></a>
