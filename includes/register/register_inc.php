            ...
            <div id="page-content">
                <form action="<?php echo SITEHOST ?>register.php" method="post" id="creation">
                    ...
                    <div class="input-row input-row-text">
                        ...
                        --><span class="input-right">
                            <span class="input-text input-text-small">
                                <input type="password" id="password" name="password" value="" class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;" maxlength="256" tabindex="1" required="required" placeholder="输入密码" />
                                <span class="inline-message " id="password-message"> </span>
                            </span>
                            <span class="input-text input-text-small">
                                <input type="password" id="rePassword" name="rePassword" value="" class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;" maxlength="256" tabindex="1" required="required" placeholder="确认输入" />
                    ...
                    <div class="input-row input-row-note" id="password-strength" style="display: none">
                        <div class="input-note border-5 glow-shadow">
                            <div class="input-note-left">
                                <p class="caption">为了您账号的安全，我们强烈建议您使用不同于战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、守望先锋及其它任何线上账号密码的密码。</p>
                            </div>
