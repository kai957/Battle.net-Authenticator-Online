    ...
    <form id="form" method="post" action="<?php echo SITEHOST ?>iframelogin.php">
        ...
        <p><label class="label" for="password">
            ...
            ?>type="password" name="password" maxlength="256" tabindex="2" autocomplete="off"/>
                   ...
                   } elseif ($loginerrorid == 999) {
                       echo '<div id="errorspan"><span id="emailAddress-message" class="inline-message">账号已被锁定!</span></div>';
                   }
                   ?></p>
        ...
        <p><label class="label" for="letters_code">
            ...
            <?php
            if ($loginerrorid == 2 && empty($_GET['isFirstLoad']))
