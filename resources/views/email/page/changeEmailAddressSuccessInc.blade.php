                        ...
                        <div id="article"
                            ...
                            <div id="article-content"
                                ...
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    您刚刚成功修改了{{config('app.name')}}账号的邮箱地址，为此我们发送了本提示邮件，并请您点击邮箱地址确认链接确认邮箱地址<br><br>
                                </p>
                                <h3 class="article-ci"
                                ...
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    您的邮箱地址已修改，请确认以下信息，为了今后能顺利管理账号，请点击下面的链接确认您的邮箱地址<br>
                                    您此前的邮箱地址：{{$oldEmailAddress}}<br>
                                    您现在的邮箱地址：{{$_USER->getUserEmail()}}<br>
                                    修改时间：{{date('Y-m-d H:i:s')}}<br>
