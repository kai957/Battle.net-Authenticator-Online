                        ...
                        <div id="article"
                            ...
                            <div id="article-content"
                                ...
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    您刚刚申请重置{{config('app.name')}}账号的密码，为此我们将密码重置链接通过本邮件发送给您，并提示您注意保护密码安全<br><br>
                                </p>
                                <h3 class="article-ci"
                                ...
                                <h3 class="article-ci" style="width:66.66%;border-bottom: 1px solid rgb(170,170,170);outline: 0;font-size: 20px;font-weight: normal;color: #000000;padding: 0 0 3px;margin: 0 0 11px;"> 密码重置链接 </h3>
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    下面是关于您本次密码重置链接的相关信息，请点击下方的链接前往密码重置页面，并按照页面要求填写<br>
                                    重置密码申请时间：{{date('Y-m-d H:i:s')}}<br>
                                    <a href='{{$findUrl}}' target='_blank'
                                       style="text-decoration: none;color: #0072a3;text-align: left;">点击重置您的密码</a><br><br>
                                </p>
                                ...
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    如果这不是您操作的，请删除本邮件，请绝对不要点击上方的链接进行操作<br>
