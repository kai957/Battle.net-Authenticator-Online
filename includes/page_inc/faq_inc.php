...
?>
<div id="layout-middle" style="height: 4100px;">
    <div id="homewrapper">
        <div id="content">
            <div id="page-content">
                <div id="breadcrumb">
                    ...
                    <div id="article-container">
                        <div id="article">
                            ...
                            <div id="article-content">
                                ...
                                <p>
                                    “战网安全令”是暴雪公司针对《战网通行证》用户推出的一项账号保护措施。绑定安全令后，您每次登入游戏或战网通行证均需输入动态验证码。“战网安全令”从根本上讲是暴雪公司设计的一种动态验证码技术，通过一定的算法，每隔30秒动态生成一个新的验证码。
                                </p>
                                ...
                                <p>
                                    ...
                                    请<span style="color: red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、守望先锋相同的密码
                                </p>
                                ...
                                <p>
                                    ...
                                    当您的邮箱地址验证成功后，邮箱地址确认状态下的图标将显示为<span class="article-has-authenticator-has-active"></span>，否则将显示为<span class="article-none-authenticator"></span><br><br/>
                                    若您注册为普通或共享账号时，我们允许您创建最多&nbsp;<?php echo MOST_AUTH; ?>&nbsp;个安全令<span style="color: red;">（好消息，由于更换了新的服务器，普通用户已经可以添加&nbsp;<?php echo MOST_AUTH; ?>&nbsp;枚安全令了）</span><br>
                                    当您的安全令数量小于&nbsp;<?php echo (int) (AUTH_HINT_LOGO_XISHU * MOST_AUTH / 3); ?>&nbsp;个时，已添加安全令数量下的图标将显示为<span class="article-has-authenticator-has-active"></span><br>
                                    <?php if(MOST_AUTH > 1){?>
                                    当您的安全令数量大于&nbsp;<?php echo (int) (AUTH_HINT_LOGO_XISHU * MOST_AUTH / 3); ?>&nbsp;小于&nbsp;<?php echo MOST_AUTH - 1; ?>&nbsp;个时，已添加安全令数量下的图标将显示为<span class="article-has-authenticator-none-active"></span><br>
                                    <?php } ?>
                                    当您的安全令数量等于&nbsp;<?php echo MOST_AUTH; ?>&nbsp;个时，已添加安全令数量下的图标将显示为<span class="article-none-authenticator"></span><br><br/>
                                    若您通过捐赠提升为捐赠者账号后，我们允许您创建最多&nbsp;<?php echo MOST_AUTH_DONATED; ?>&nbsp;个安全令<br>
                                    当您的安全令数量小于&nbsp;<?php echo (int) (AUTH_HINT_LOGO_XISHU_DONATED * MOST_AUTH_DONATED / 3); ?>&nbsp;个时，已添加安全令数量下的图标将显示为<span class="article-has-authenticator-has-active"></span><br>
                                    当您的安全令数量大于&nbsp;<?php echo (int) (AUTH_HINT_LOGO_XISHU_DONATED * MOST_AUTH_DONATED / 3); ?>&nbsp;小于&nbsp;<?php echo MOST_AUTH_DONATED; ?>&nbsp;个时，已添加安全令数量下的图标将显示为<span class="article-has-authenticator-none-active"></span><br>
                                    当您的安全令数量等于&nbsp;<?php echo MOST_AUTH_DONATED; ?>&nbsp;个时，已添加安全令数量下的图标将显示为<span class="article-none-authenticator"></span>
                                </p>
                                ...
                                <p>
                                    ...
                                    在这里，您可以通过三种方式快速地向您的账号中添加一枚新的战网安全令，请注意，您最多只能添加&nbsp;<?php echo MOST_AUTH; ?>(普通用户)&nbsp;/&nbsp;<?php echo MOST_AUTH_DONATED; ?>(捐赠用户)&nbsp;枚安全令至您的账号。<br>
                                ...
                                <p>如果您已经<a href="<?php echo SITEHOST; ?>addauth.php">添加安全令</a>，请访问<a href="<?php echo SITEHOST; ?>myauthall.php">我的安全令</a>页面<br>
                                    在该页面中您可以管理您已有的安全令，如果您的安全令总数小于&nbsp;<?php echo MOST_AUTH; ?>(普通账号)&nbsp;/&nbsp;<?php echo MOST_AUTH_DONATED; ?>(捐赠者账号)&nbsp;枚，右上角还会显示添加按钮<br>
                                ...
                                <p class="alignleft" style="font-size: 16px;">2、我该如何查看我的动态验证码<br></p>
                                <p>如果您已经<a href="<?php echo SITEHOST; ?>addauth.php">添加安全令</a>，请访问<a href="<?php echo SITEHOST; ?>">首页</a>或<a href="<?php echo SITEHOST; ?>auth.php">默认安全令</a>页面<br>
                                    ...
                                    您可以在任何一枚安全令动态验证码显示页面右侧或<a href="<?php echo SITEHOST ?>account.php">我的账号</a>页面中间查看到我的安全令，包括安全令图标、名称、序列号信息，点击可跳转至该枚安全令对应的动态验证码显示页面<br>
                                    如果您的安全令总数小于&nbsp;<?php echo MOST_AUTH; ?>(普通账号)&nbsp;/&nbsp;<?php echo MOST_AUTH_DONATED; ?>(捐赠者账号)&nbsp;枚，上述内容下方还会包含<a href="<?php echo SITEHOST ?>addauth.php">添加安全令</a>按钮<br>
                                ...
                                <p>额，你问我，我问谁，我只知道在我的最大限度下能保证本站的安全，您的密码也被加密保存，不会有类似CSDN这种SB事件出现<br>
                                    重复一遍，请<span style="color: red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、守望先锋相同的密码<br>
