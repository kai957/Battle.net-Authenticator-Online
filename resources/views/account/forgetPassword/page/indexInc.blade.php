<div id="layout-middle">
    <div id="homewrapper">
        <div id="content">
                ...
                <div class="alert error closeable border-4 glow-shadow">
                    <div class="alert-inner">
                        <div class="alert-message">
                            ...
                            <ul>
                                <li>
                                    {{$forgetPasswordCheckUtils->getErrorString($forgetPasswordCheckUtils->getForgetPasswordCheckErrorCode())}}
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <form id="support-form" class="login-support-form" novalidate="novalidate" action="/forgetPassword"
                  method="post">
                {{csrf_field()}}
                <div class="input-row input-row-text">
                    ...
                    --><span class="input-right">
                        <span class="input-text input-text-medium">
                            <input name="firstName" id="firstName" class="medium border-5 glow-shadow-2"
                                   autocomplete="off" maxlength="32" tabindex="1" required="required" type="text">
                ...
                <div class="input-row input-row-note question-info" id="question-info" style="display: none;">
                        <span id="question1-message"
                              class="inline-message no-text-clear">您将需要使用该信息进行身份验证，确定您是账号所有者。</span>
                </div>
