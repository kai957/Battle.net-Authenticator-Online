                ...
                <div class="columns-2-1 settings-content">
                    <div class="column column-left">
                        <div class="password-entry">
                            ...
                            <form method="post" action="/resetPassword" id="change-settings" novalidate="novalidate">
                                <div class="input-hidden">
                                    {{csrf_field()}}
                                    <input type="hidden" id="csrftoken" name="userId"
                                           value="{{$resetPasswordUtils->getUserId()}}"/>
                                    <input type="hidden" id="csrftoken" name="token"
                                           value="{{$resetPasswordUtils->getToken()}}"/>
                                </div>
                                <div class="input-row input-row-text">
                                    ...
                                    --><span class="input-right">
                                        <span class="input-text input-text-small">
                                            <input readonly="readonly" type="text" id="oldPassword" name="oldPassword"
                                                   value="{{$resetPasswordUtils->getUser()->getUserEmail()}}"
                                                   class="small border-5 glow-shadow-2" autocomplete="off"
                                                   onpaste="return false;" maxlength="320" tabindex="1"
                ...
                $(function () {
                    ...
                    var settings = new ChangePassword('#change-settings', {
                        passwordFields: [
                            '#newPassword',
                            '#newPasswordVerify'
                        ], emailAddress: '{{$resetPasswordUtils->getUser()->getUserName()}}'
                    });
                });
                //]]>
            </script>
