...
<div id="layout-middle" style="height:2688px; ">
    <div id="homewrapper">
        <div id="content">
            <div id="page-content">
                <div id="breadcrumb">
                        ...
                        <div id="article">
                            ...
                            <div id="article-content">
                                <p>
                                    ...
                                    包括且不限于魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、守望先锋、战网Battle.Net<br>
                                ...
                                <p>
                                    通过我们申请或还原的安全令与战网手机安全令显示的验证码一致，验证码刷新时间误差基本在3秒以内，误差取决于您连接到我们服务器的延迟
                                </p>
                                <p>
                                    若想要使用我们的服务，请<a href="<?php echo SITEHOST ?>register.php">注册</a>或<a href="<?php echo SITEHOST ?>login.php">登入</a>您的账号
                                </p>
                                <p>
                                    访问<a href="<?php echo SITEHOST ?>addauth.php">添加安全令</a>来为您的账号添加一枚安全令，访问<a href="<?php echo SITEHOST ?>auth.php">默认安全令</a>查看您设置的默认安全令。<br>每个账号最多可以添加&nbsp;<?php echo MOST_AUTH; ?>&nbsp;枚安全令<span style="color:red;">（好消息，由于更换了新的服务器，即日起普通用户已经可以添加&nbsp;<?php echo MOST_AUTH; ?>&nbsp;枚安全令了）</span><br/>如果您成为捐赠用户，您最多可以添加&nbsp;<?php echo MOST_AUTH_DONATED; ?>&nbsp;枚安全令<br>
                                    如果您已经<a href="<?php echo SITEHOST ?>login.php">登入</a>且拥有一枚<a href="<?php echo SITEHOST ?>auth.php">默认安全令</a>，那么首页将显示默认安全令的动态验证码，您可以保存成书签方便今后查看<br>
                                    在安全令页面中您可以点击刷新安全令验证码按钮刷新显示的动态验证码与时间滚动条，点击复制安全令验证码按钮复制当前的安全令验证码<br>
                                    <img src="<?php echo SITEHOST ?>doc/img/auth.jpg" alt=""><br><br>
                                    2016年6月起，战网官方推出了一键登录功能，您可以在战网或者其客户端上登录，在确认安全令页面，现在会显示如下页面<br>
                                    <img src="<?php echo SITEHOST ?>doc/img/netpageinfo.png" alt=""><br>
                                    现在使用战网安全令在线版，您只需要在弹窗中点击允许即可登录，或点击拒绝取消登录请求，而无需再输入安全令，是的，我们现已支持该功能<br>
                                    <img src="<?php echo SITEHOST ?>doc/img/onkeyintro.png" alt=""><br><br>
                                ...
                                <p>
                                    ...
                                    请务必记住您的注册信息，该信息将在您重置密码、更改邮箱地址时使用。请<span style="color:red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、守望先锋相同的密码，以免发生纠纷<br>
                                    注册前请仔细查看<a href="<?php echo SITEHOST ?>copyright.php">版权声明与免责条款</a>，您未来可能发生的一切账号失窃事件均与本站无关，重复一遍，请<span style="color:red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、守望先锋相同的密码
                                </p>
                                <p>
