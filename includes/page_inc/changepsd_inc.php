                ...
                <div class="columns-2-1 settings-content" style="height: 420px;">
                        ...
                        <div class="password-entry">
                            ...
                            <form method="post" action="<?php echo SITEHOST; ?>changepwd.php" id="change-settings" novalidate="novalidate">
                                <div class="input-row input-row-text">
                                    ...
                                    --><span class="input-right">
                                        <span class="input-text input-text-small">
                                            <input type="password" id="oldPassword" name="oldPassword" value="" class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;" maxlength="256" tabindex="1" required="required" placeholder="输入旧密码" />
                                ...
                                <div class="input-row input-row-text">
                                    ...
                                    --><span class="input-right">
                                        <span class="input-text input-text-small">
                                            <input type="password" id="newPassword" name="newPassword" value="" class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;" maxlength="256" tabindex="1" required="required" placeholder="输入新密码" />
                                ...
                                <div class="input-row input-row-text">
                                    ...
                                    --><span class="input-right">
                                        <span class="input-text input-text-small">
                                            <input type="password" id="newPasswordVerify" name="newPasswordVerify" value="" class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;" maxlength="256" tabindex="1" required="required" placeholder="重新输入新密码" />
                    ...
                    <div class="column column-right">
                        <div class="password-requirements">
                            ...
                            <p class="caption">为了您的安全，我们强烈建议您使用不同于战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、守望先锋及其它任何线上账号密码的密码。</p>
                        </div>
                    </div>
                </div>
            </div>
