...
<script>
    var pollingUrl = '<?php echo SITEHOST; ?>oneKeyLogin/getLoginInfo.php?authid=<?= $row['auth_id']; ?>';
    var oneKeyLoginUrl = '<?php echo SITEHOST;?>iframeOneKeyLogin.php?json=';
</script>
<script type="text/javascript" src="resources/js/oneKeyLogin.js"></script> 
                ...
                <div id="manage-security" class="manage-security">
                    <div id="dashboard" class="dashboard">
                        ...
                        <div class="security-image">
                            ...
                            <submit class="ui-button button1" id="creation-submit" tabindex="1"><span class="button-left"><span class="button-right">复制令牌验证码</span></span></button>
                        </div>
                        <h3 class="baoguanhaomima">请妥善保管验证码，不要将其随意告知他人。<br>若安全令显示不准确，请访问<a href="<?php echo SITEHOST ?>myauthall.php">我的安全令</a>对令牌重新进行校时。</h3>
                        <submit class="ui-button button1" id="refreshcode" onclick="refreshcodegeas();" tabindex="1"><span class="button-left"><span class="button-right">刷新令牌验证码</span></span></button>
                    </div>
                </div>
                <div id="lobby-games">
                    <div id="games-list"> 
