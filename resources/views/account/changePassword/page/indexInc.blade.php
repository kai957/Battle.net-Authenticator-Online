                ...
                <div class="alert error closeable border-4 glow-shadow">
                    <div class="alert-inner">
                        <div class="alert-message">
                            <p class="title">
                                <strong>
                                    <a name="form-errors"> </a>发生下列错误：
                                </strong>
                            </p>
                            <ul>
                                <li>
                                    {{$changePasswordUtils->getErrorString($changePasswordUtils->getChangePasswordErrorCode())}}
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="columns-2-1 settings-content" style="height: 420px;">
                    <div class="column column-left">
                        <div class="password-entry">
                            ...
                            <form method="post" action="/changePassword" id="change-settings" novalidate="novalidate">
                                {{csrf_field()}}
                                    ...
                                    --><span class="input-right">
                                        <span class="input-text input-text-small">
                                            <input type="password" id="oldPassword" name="oldPassword" value=""
                                                   ...
                                                   onpaste="return false;" maxlength="256" tabindex="1"
                                                   required="required" placeholder="输入旧密码"/>
                                    ...
                                    --><span class="input-right">
                                        <span class="input-text input-text-small">
                                            <input type="password" id="newPassword" name="newPassword" value=""
                                                   class="small border-5 glow-shadow-2" autocomplete="off"
                                                   onpaste="return false;" maxlength="256" tabindex="1"
                                                   required="required" placeholder="输入新密码"/>
                                    ...
                                    --><span class="input-right">
                                        <span class="input-text input-text-small">
                                            <input type="password" id="newPasswordVerify" name="newPasswordVerify"
                                                   value="" class="small border-5 glow-shadow-2" autocomplete="off"
                                                   onpaste="return false;" maxlength="256" tabindex="1"
                                                   required="required" placeholder="重新输入新密码"/>
                                ...
                                <div class="input-row input-row-text">
                                    ...
                                    <span class="input-right">
                                        <div class="imgandreloader">
                                            <div id="captcha-image" style="width: 200px;height: 70px;"><img
                                                        id="sec-string" onclick="refreshCaptcha();
                                                    document.getElementById('letters_code').focus();"
                                                        src="/api/captchaCode?rand={{time()}}" alt="换一个" title="换一个"
                                                        class="border-5"/></div>
                                            <div id="captcha-reloader">
                                                ...
                                                <script type='text/javascript'>
                                                    ...
                                                    //]]>
                                                        ...
                                                        class="static">
                                                    <p><label class="label" for="yanzhenma"
                                                              style="top:4px;position:relative;">
                                                            出于安全性考虑，请输入上图中的字符。（这并不是您的密码）</label>
                                                    </p></span></span>
                                        </div>
                                        <span class="input-text input-text-small">
                                            <input type="text" name="letters_code" value="" onblur="if (!jquerycodechecked) {
                                                        checkyanzhenma(this.value);
                                                    }" id="letters_code" class="small border-5 glow-shadow-2"
                                                   autocomplete="off" onpaste="return false;" maxlength="6" tabindex="1"
                                                   required="required" placeholder="输入验证码"/>
                                            <span id="checkyanzhenmaajax"></span>
                                            <div id="errorspan" style="position:relative;top:4px;">
                                ...
                                <div class="submit-row" id="submit-row">
                                    ...
                                    <div class="input-right">
                                        <button class="ui-button button1" type="submit" id="password-submit"
                                                tabindex="1" onClick='return submitcheck();'><span
                                                    class="button-left"><span class="button-right">继续</span></span>
                                        </button>
                    ...
                    <div class="column column-right">
                        <div class="password-requirements">
                            ...
                            <p class="caption">
                                为了您的安全，我们强烈建议您使用不同于{{config('app.game_list')}}及其它任何线上账号密码的密码。</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                $(function () {
                    ...
                    var settings = new ChangePassword('#change-settings', {
                        passwordFields: [
                            '#newPassword',
                            '#newPasswordVerify'
                        ], emailAddress: '{{$_USER->getUserName()}}'
                    });
                });
                //]]>
            </script>
