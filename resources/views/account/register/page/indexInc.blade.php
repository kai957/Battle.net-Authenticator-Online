...
<div id="layout-middle">
    <div id="homewrapper">
        <div id="content">
            @if(!empty(@$registerErrorInfo))
                <div class="alert error closeable border-4 glow-shadow">
                    <div class="alert-inner">
                        <div class="alert-message">
                            <p class="title">
                                <strong><a name="form-errors"> </a>发生下列错误：</strong>
                            </p>
                            <ul>
                                <li>{{$registerErrorInfo}}
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div id="page-header">
                <p class="privacy-message">
                    <b>我们保护您的个人信息安全。</b>
                    阅读我们的<a href="/copyright" target="_blank">版权声明及免责条款</a>，了解您的注意事项。
                </p>
            </div>
            <div id="page-content">
                <form action="/register" method="post" id="creation">
                    {{ csrf_field() }}
                        ...
                        --><span class="input-right">
                            <span class="input-text input-text-small">
                                <input type="text" name="username" value="" id="firstname"
                                       onblur="checkname(this.value);" class="small border-5 glow-shadow-2"
                                       autocomplete="off" maxlength="32" tabindex="1" required="required"
                                       placeholder="仅允许使用中文、数字、字母及下划线"/>
                        ...
                        --><span class="input-right">
                            <span class="input-text input-text-small">
                                <input type="password" id="password" name="password" value=""
                                       ...
                                       maxlength="256" tabindex="1" required="required" placeholder="输入密码"/>
                                <span class="inline-message " id="password-message"> </span>
                            </span>
                            <span class="input-text input-text-small">
                                <input type="password" id="rePassword" name="rePassword" value=""
                                       class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;"
                                       maxlength="256" tabindex="1" required="required" placeholder="确认输入"/>
                    ...
                    <div class="input-row input-row-note" id="password-strength" style="display: none">
                        <div class="input-note border-5 glow-shadow">
                            <div class="input-note-left">
                                <p class="caption">
                                    为了您账号的安全，我们强烈建议您使用不同于{{config('app.game_list')}}及其它任何线上账号密码的密码。</p>
                            </div>
                            <div class="input-note-right border-5">
                                <div class="password-strength">
                                    ...
                                    <span class="password-rating"><span class="rating rating-default"
                                                                        id="password-rating"></span></span>
                                </div>
                    ...
                    <div class="input-row input-row-text">
                        ...
                        --><span class="input-right">
                            <span class="input-text input-text-small">
                                <input type="email" name="emailAddress" value="" id="emailAddress"
                                       class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;"
                                       maxlength="320" tabindex="1" required="required" placeholder="输入邮箱地址"/>
                                <span class="inline-message " id="emailAddress-message"> </span>
                            </span>
                            <span class="input-text input-text-small">
                                <input type="email" name="emailAddressConfirmation" value=""
                                       id="emailAddressConfirmation" class="small border-5 glow-shadow-2"
                                       autocomplete="off" onpaste="return false;" maxlength="320" tabindex="1"
                                       required="required" placeholder="确认输入"/>
                    ...
                    <div class="input-row input-row-select">
                        ...
                        --><span class="input-right">
                            <span class="input-select input-select-small">
                                <select name="question1" id="question1" class="small border-5 glow-shadow-2"
                            ...
                            <span class="input-text input-text-small">
                                <input type="text" name="answer1" value="" id="answer1"
                                       class="small border-5 glow-shadow-2" autocomplete="off" maxlength="100"
                                       tabindex="1" required="required" placeholder="答案"/>
                        ...
                        <span class="input-right">
                                ...
                                <div id="captcha-image" style="width: 200px;height: 70px;">
                                    <img id="sec-string" onclick="refreshCaptcha();
                                        document.getElementById('letters_code').focus();"
                                         ...
                                         alt="换一个" title="换一个" class="border-5"/>
                                </div>
                            ...
                            <span class="input-text input-text-small">
                                <input type="text" name="letters_code" value="" onblur="if (!jquerycodechecked) {
                                        ...
                                        }" id="letters_code" class="small border-5 glow-shadow-2" autocomplete="off"
                                       onpaste="return false;" maxlength="6" tabindex="1" required="required"
                                       placeholder="输入验证码"/>
                        ...
                        <span class="input-right">
                            <span class="input-text">
                                <input id="lowright" onclick="if (this.checked) {
                                        return confirm('共享账号将无法查看令牌的序列号及还原码,仅可查看动态密码,且{{config('app.share_account_cookie_valid_hours')*60}}分钟内只允许一个客户端登录,如果您是自己使用,选中本选项将对您的使用造成极大不便.\n点确定注册共享账号,如果您看不懂前面的内容点取消.')
                    ...
                    <div class="input-row input-row-verification">
                        ...
                        <span class="input-right"><span class="input-static input-static-extra-large"><span
                                        class="static">
                                    <p>
                                        点击下方的“免费注册”按钮即代表我同意<a href="/copyright"
                                                              target="_blank">
                                            版权声明及免责条款
                                        </a>。
                                    </p>
                    ...
                    <div class="submit-row">
                        ...
                        <div class="input-right">
                            <button class="ui-button button1" type="submit" onClick='return submitcheck();'
                                    id="creation-submit" tabindex="1">
                                <span class="button-left">
                                    <span class="button-right">免费注册{{config('app.name')}}账号</span>
                                </span>
                            </button>
                            <a class="ui-cancel "
                               href="/"
