                        ...
                        <div id="article"
                            ...
                            <div id="article-content"
                                ...
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    您刚刚成功修改了{{config('app.name')}}账号的密码，为此我们发送了本邮件，并请注意保护密码安全<br><br>
                                </p>
                                <h3 class="article-ci"
                                ...
                                <h3 class="article-ci" style="width:66.66%;border-bottom: 1px solid rgb(170,170,170);outline: 0;font-size: 20px;font-weight: normal;color: #000000;padding: 0 0 3px;margin: 0 0 11px;"> 密码修改信息 </h3>
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    下面是关于您本次操作的信息<br>
