                        ...
                        <div id="article"
                            ...
                            <div id="article-content"
                                ...
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    您刚刚成功重置了{{config('app.name')}}账号的密码，为此我们发送了本邮件，并请注意保护密码安全<br><br>
                                </p>
                                <h3 class="article-ci"
                                ...
                                <h3 class="article-ci" style="width:66.66%;border-bottom: 1px solid rgb(170,170,170);outline: 0;font-size: 20px;font-weight: normal;color: #000000;padding: 0 0 3px;margin: 0 0 11px;"> 密码重置信息 </h3>
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    下面是关于您本次操作的信息<br>
                                    您的新密码：{{Functions::emailHidePassword($unMd5Password)}} （只显示前三位）<br>
                                    重置时间：{{date('Y-m-d H:i:s')}}<br><br>
                                </p>
                                ...
                                <p class="alignleft" style="margin: 0;padding: 0;border: 0;outline: 0;text-align: left;margin-bottom: 5px;">
                                    如果这不是您操作的，请前往网站<a  style="text-decoration: none;color: #0072a3;text-align: left;" href='{{config('app.url')}}forgetPassword' target='_blank'>重置您的密码</a><br>
                                    本邮件为自动发送，请不要直接回复，如需联系请<a href="mailto:{{config('app.app_host_email')}}"  target="_blank" style="text-decoration: none;color: #0072a3;text-align: left;">点击此处</a><br><br>
                                </p>
